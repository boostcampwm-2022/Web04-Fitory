...
export default function () {
  ...
  let userId = Math.round(randomIntBetween(1, 5000));
  ...
  group("DB Read Test", function () {
    group("USER API", function () {
      const response = http.batch([
        ...
        {
          method: "GET",
          url: `http://localhost:8080/api/users/profile/list`,
          body: {},
          params: params,
        },
        {
          method: "GET",
          url: `http://localhost:8080/api/users/recommand/list?userId=${userId}`,
          body: {},
          params: params,
        },
        {
          method: "GET",
          url: `http://localhost:8080/api/users/checkName/userName=${userId.toString()}`,
          body: {},
          params: params,
        },
      ]);
